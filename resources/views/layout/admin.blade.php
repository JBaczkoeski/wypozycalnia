...
<nav class="navbar navbar-expand-lg navbar-border mb-1 shadow" style="background-color: rgb(13,33,59)">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse col-6" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="btn @if(Request::is('admin')) active @endif fw-bold text-white" href="/admin">Strona główna</a>
                </li>
                <li class="nav-item">
                    <a class="btn @if(Route::is('carsList')) active @endif fw-bold text-white" href="/admin/samochody">Samochody</a>
                </li>
                <li class="nav-item">
                    <a class="btn @if(Request::is('informacje')) active @endif fw-bold text-white" href="/informacje">Urzytkownicy</a>
                </li>
                <li class="nav-item">
                    <a class="btn @if(Request::is('kontakt')) active @endif fw-bold text-white"
                       href="/kontakt">Wiadomości może do pracowników</a>
                </li>
            </ul>
        </div>
        @guest()
